    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a
          ...
          className="flex items-center space-x-3 mb-4 lg:mb-0 rtl:space-x-reverse"
        >
          <img
        ...
        <div className="flex w-full lg:w-1/2">
          <div className="relative w-full">
            ...
            <button
              type="submit"
              className="absolute top-0 end-0 p-2.5 h-full text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
        ...
        <div
          className="hidden w-full mx-auto md:mx-0 md:block md:w-auto py-4 lg:my-0"
          id="navbar-default"
        >
